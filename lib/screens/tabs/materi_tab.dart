          ...
          child: Container(
            ...
            child: const Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text(
                  'Mempelajari array, linked list, stack, queue, dan tree.',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 16,
                  ),
          ...
          child: Container(
            ...
            child: const Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text(
                  'Konsep algoritma dan penerapannya dalam pemrograman.',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 16,
                  ),
          ...
          child: Container(
            ...
            child: const Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text(
                  'Dasar-dasar database, ERD, dan SQL.',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 16,
                  ),
        ...
        Card(
          ...
          child: Container(
            ...
            child: const Column(
              ...
              children: [
                Text(
                  'Bab 6: Rekayasa Perangkat Lunak',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                ...
                SizedBox(height: 8),
                Text(
                  'Analisis, perancangan, dan pengujian perangkat lunak.',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 16,
                  ),
